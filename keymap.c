 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      | Alt  | OS   | Sp/Lw| En/Rs| Alt  | Left | Down | Up   | Right|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
   ...
   _______, _______, _______, KC_LALT, KC_LGUI, LT(_LOWER,KC_SPC), LT(_RAISE,KC_ENT), KC_RALT,KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT  \
),
